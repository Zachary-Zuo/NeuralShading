...
def test_checkpoint_v3_roundtrip_and_tensor_schema(tmp_path):
    ...
    checkpoint = TrainingCheckpoint(
        ...
        config, sha256_json(config), "reference-program:test", "query-stream:test",
    ...
    assert restored.format_version == 3 and restored.step == 7
