...
同时复用现已归档架构任务的[视觉盘点](../../archive/2026-09/09-05-architecture-reset-training-workflow/research/architecture-audit.md:49)。该盘点区分 viewer 输出与素材筛选缩略图，避免把所有 PNG 都当模型结果。
