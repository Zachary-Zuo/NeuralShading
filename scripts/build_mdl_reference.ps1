...
$sdkRoot = Join-Path $projectRoot "external\MDL-SDK-2025.0.0-387700.1252-nt-x86-64"
$stbRoot = Join-Path $projectRoot "external\stb"
...
$executable = Join-Path $buildRoot "$Configuration\ncls_mdl_sdk_bridge.exe"
